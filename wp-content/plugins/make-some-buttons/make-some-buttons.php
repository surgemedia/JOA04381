...
function basic_content_replace_buttons ($text)
{
	...
	$sethandsfreestart = "<a class='btn btn-primary icon-play button_filled button_blue' href='/play/?game=hands&val=";
	$sethandsfreeend = "'>PLAY LESSON HANDS</a>";
	$sethandstipsfreestart = "<a class='btn btn-primary icon-play button_filled button_blue' href='/play/?game=hands&level=0&val=";
	$sethandstipsfreeend = "'>PLAY TIPS HANDS</a>";
    $lessonhandsstart = "<a class='btn btn-primary icon-play button_filled button_blue' href='/play/?game=coffee&val=";
