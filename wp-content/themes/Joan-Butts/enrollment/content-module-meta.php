<ul class="each_modules_fields col-lg-12">
				...
				<li class="col-lg-4 col-md-8 col-sm-8 col-sm-12"><span class="dashicons dashicons-book-alt"></span>
				...
				<li class="col-lg-4 col-md-8 col-sm-8 col-sm-12">
				<span class="dashicons dashicons-awards"></span>
				<p><?php the_field('text', $GLOBALS['current_course_obj']); ?></p>
				</li >
				<?php endif ?>
				<?php if (get_field('forum', $GLOBALS['current_course_obj'])): ?>
				<li class="col-lg-2 col-md-8 col-sm-8 col-sm-12"><span class="dashicons dashicons-admin-comments"></span>
				<p>Discuss this</a>
				</p></li>
				<?php endif ?>
